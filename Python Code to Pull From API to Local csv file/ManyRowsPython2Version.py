...
profile_ids = profile_ids = {'No Filter':   '66852241'}
...
date_ranges = [('2017-09-01',
                '2019-12-17')]

for profile in sorted(profile_ids):
  path = 'C:\\Users\\Admin Juntao\\Desktop' #replace with path to your folder where csv file with data will be written
  filename = 'google_analytics_data_all.csv' #replace with your filename. Note %s is a placeholder variable and the profile name you specified on row 162 will be written here
  with open(path + filename.lower(), 'wt') as f:
